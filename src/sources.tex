...
\begin{itemize}
    ...
    \item Mantine v4.0.8 \url{https://mantine.dev/}
    \item GraphQL Code Generator \url{https://www.graphql-code-generator.com/}
    \item Prettier v2.6.2 \url{https://prettier.io/}
    \item ESLint v8.12.0 \url{https://eslint.org/}
    \item Ostatni zavislosti je dostupne na \url{https://github.com/stegoer/client/blob/master/package-lock.json}
\end{itemize}
...
\begin{itemize}
    ...
    \item gorilla/mux v1.8.0 \url{http://www.gorillatoolkit.org/pkg/mux}
    \item Viper v1.10.1 \url{https://pkg.go.dev/github.com/spf13/viper}
    \item zap v1.21.0 \url{https://pkg.go.dev/go.uber.org/zap}
    \item Ostatni zavislosti je dostupne na \url{https://github.com/stegoer/server/blob/main/go.sum}
\end{itemize}
